...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * T-ODO (Task 1): Create another constructor that takes in TWO parameters,
    ...
    public static void main(String[] args) {
        ...
        /**
         * T-ODO (Task 2): Below are a bunch of calls to countStatic using
    ...
    public String toString(){
        // T-ODO (Task 3): Implement the body of this method!
        return this.name;
    }
    ...
    public boolean equals(Object o) {
        /**
         * T-ODO (Task 4): Complete the body of this method!
    ...
    public int compareTo(Silly other) {
        /**
         * T-ODO (Task 5): Implement the body of this method.
